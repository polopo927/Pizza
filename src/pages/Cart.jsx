...
export const Cart = () => {
  ...
  const totalPizzas = pizzas.reduce((sum, pizza) => sum + pizza.count, 0)
  // const totalPrice = pizzas.reduce((sum, pizza) => (pizza.price * pizza.count) + sum, 0)
      ...
      <div className="cart">
        ...
        <div className="cart__bottom">
          <div className="cart__bottom-details">
            <span> Всего пицц: <b>{totalPizzas}</b> </span>
